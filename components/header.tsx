...
export default function Header() {
  ...
  return (
   ...
   <nav className="relative z-50 flex h-full items-center justify-between px-4">
            ...
            <AnimatePresence>
              {menuOpen && (
                <m.ul
                  ...
                  className="absolute top-full left-0 w-full bg-white dark:bg-neutral-dark shadow-lg flex flex-col items-center gap-2 py-4 z-50 sm:hidden border-b border-primary/20 dark:border-primary-dark/30">
                  {links.map((link) => (
                    <li
                      key={link.hash}
                      className="w-full">
